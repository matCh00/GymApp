...
const BodyPartsFront = (props: any) => {
  ...
  const [trapsColor, setTrapsColor] = useState("#F8D8D8");
  const [deltsColor, setDeltsColor] = useState("#F8D8D8");
  const [bicepsColor, setBicepsColor] = useState("#F8D8D8");
  const [tricepsColor, setTricepsColor] = useState("#F8D8D8");
  const [pecsColor, setPecsColor] = useState("#F8D8D8");
  const [forearmsColor, setForearmsColor] = useState("#F8D8D8");
  const [upperAbsColor, setUpperAbsColor] = useState("#F8D8D8");
  const [lowerAbsColor, setLowerAbsColor] = useState("#F8D8D8");
  const [latsColor, setLatsColor] = useState("#F8D8D8");
  const [obliqueColor, setObliqueColor] = useState("#F8D8D8");
  const [backColor, setBackColor] = useState("#F8D8D8");
  const [lowerBackColor, setLowerBackColor] = useState("#F8D8D8");
  const [glutesColor, setGlutesColor] = useState("#F8D8D8");
  const [hamsColor, setHamsColor] = useState("#F8D8D8");
  const [calvesColor, setCalvesColor] = useState("#F8D8D8");
  const [quadsColor, setQuadsColor] = useState("#F8D8D8");
  ...
  return (
    ...
    >
      <Image
        ...
        x={-156.248}
        y={-83.045}
        href={require("../../assets/images/muscles_front.png")}
      />
      ...
      <Path
        ...
        fillOpacity={0.6}
        onPressIn={() => {
          setDeltsColor("#FF8888");
        }}
        onPressOut={() => {
          setDeltsColor("#F8D8D8");
        }}
        onPress={() => {
      ...
      <Path
        ...
        fillOpacity={0.6}
        onPressIn={() => {
          setTricepsColor("#FF8888");
        }}
        onPressOut={() => {
          setTricepsColor("#F8D8D8");
        }}
        onPress={() => {
          console.log("shape pressed");
        }}
      ...
      <Path
        ...
        fillOpacity={0.6}
        onPressIn={() => {
          setBicepsColor("#FF8888");
        }}
        onPressOut={() => {
          setBicepsColor("#F8D8D8");
        }}
        onPress={() => {
          console.log("shape pressed");
        }}
      ...
      <Path
        ...
        fillOpacity={0.6}
        onPressIn={() => {
          setTrapsColor("#FF8888");
        }}
        onPressOut={() => {
          setTrapsColor("#F8D8D8");
        }}
        onPress={() => {
          console.log("shape pressed");
        }}
      ...
      <Path
        ...
        fillOpacity={0.6}
        onPressIn={() => {
          setObliqueColor("#FF8888");
        }}
        onPressOut={() => {
          setObliqueColor("#F8D8D8");
        }}
        onPress={() => {
          console.log("shape pressed");
        }}
      ...
      <Path
        ...
        fillOpacity={0.6}
        onPressIn={() => {
          setForearmsColor("#FF8888");
        }}
        onPressOut={() => {
          setForearmsColor("#F8D8D8");
        }}
        onPress={() => {
          console.log("shape pressed");
        }}
      ...
      <Path
        ...
        fillOpacity={0.6}
        onPressIn={() => {
          setGlutesColor("#FF8888");
        }}
        onPressOut={() => {
          setGlutesColor("#F8D8D8");
        }}
        onPress={() => {
          console.log("shape pressed");
        }}
      ...
      <Path
        ...
        fillOpacity={0.6}
        onPressIn={() => {
          setQuadsColor("#FF8888");
        }}
        onPressOut={() => {
          setQuadsColor("#F8D8D8");
        }}
        onPress={() => {
          console.log("shape pressed");
        }}
        stroke="#F8D8D8"
        d="m81.765 145.286 6.161-7.354 7.577 8.419 4.442 10.525.261 6.315-7.055 8.945-1.568 7.894.261 11.314v10.261l.127 9.029-.343 6.727-.045 21.08c-.118 5.939-.087 6.852-1.305 10.524l-2.876 7.894c-1.269 3.455-1.448 3.571-3.217 6.466l-4.36 6.163c-1.777 1.556-3.117-.422-3.135-1.841l-6.556-4.598s-6.456-2.308-8.406-1.75l-8.294.822c-2.374.651-2.663-2.51-2.733-7.104l-.402-6.156-1.919-11.034c-.732-6.407 1.044-12.574 1.828-16.313l2.442-13.961 5.749-16.787 4.759-24.47 3.838-9.209 3.769-5.801z"
      />
      ...
      <Path
        ...
        fillOpacity={0.6}
        onPressIn={() => {
          setCalvesColor("#FF8888");
        }}
        onPressOut={() => {
          setCalvesColor("#F8D8D8");
        }}
        onPress={() => {
          console.log("shape pressed");
        }}
      ...
      <Path
        ...
        fillOpacity={0.6}
        onPressIn={() => {
          setUpperAbsColor("#FF8888");
        }}
        onPressOut={() => {
          setUpperAbsColor("#F8D8D8");
        }}
        onPress={() => {
          console.log("shape pressed");
        }}
      ...
      <Path
        ...
        fillOpacity={0.6}
        onPressIn={() => {
          setLowerAbsColor("#FF8888");
        }}
        onPressOut={() => {
          setLowerAbsColor("#F8D8D8");
        }}
        onPress={() => {
          console.log("shape pressed");
        }}
